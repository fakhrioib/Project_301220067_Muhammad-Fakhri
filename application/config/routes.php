...
$route['absensi_siswa'] = 'AbsensiSiswa/index';
$route['absensi_guru'] = 'AbsensiGuru/index';
$route['data_siswa'] = 'DataSiswa/index';
$route['data_guru'] = 'DataGuru/index';
$route['data_petugas'] = 'DataPetugas/index';
